...
public class RequestDetails {
    ...
    public String getWorkmanMobile() {
        return workmanMobile;
    }

    public void setWorkmanMobile(String workmanMobile) {
        this.workmanMobile = workmanMobile;
    }
    ...
    public void setDateFromYear(String dateFromYear) {
    ...
    public void setDateFromMonth(String dateFromMonth) {
    ...
    public void setDateFromDay(String dateFromDay) {
    ...
    public String getWorkmanCount() {
        return workmanCount;
    }

    public void setWorkmanCount(String workmanCount) {
        this.workmanCount = workmanCount;
    }
